    ...
    $.initPagination = function (info) {
        ...
        var pager = {
            ...
            CreateNavi: function () {
                ...
                var n2 = "<a class=\"navi\"  style=\"background:blue;color:white;\">{text}</a>";
                var navi = pager.$nav;
                navi.empty();
                ...
                for (i = s1; i <= s2; i++) { //当前页                   
                    if(i==info.thisPageIndex){
                    	temp = n2.replace("{text}","<font >" + i + "</font>");
                    }else{
