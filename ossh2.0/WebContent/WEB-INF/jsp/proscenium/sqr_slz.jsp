...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
        ...
        <div class="min c">
						...
						<div class="dqwz">
                        	<h4>
                                ...
                                <a href="taskCenter.html">我的服务</a>
                                 <span> > </span>
                                <a href="taskCenter_sp.html" class="link">受理中</a>
                            </h4>
                        </div>
                        
                        <div class="pdg55">
                            <div class="yw_xq" id="slzContent">
                            	<div class="tob">
                                	<h4>
                                        <strong>事项名称</strong>
                                        <i>&nbsp;</i>
	     ...
	     <div class="pagin">
	    	<div class="message">共<i class="blue">${pageInfo.total}</i>条记录</div>
	        <ul class="paginList">
	        	<c:forEach begin="1" end="${pageInfo.currPage}" var="i">
		        	<li class="paginItem" id="${i}"><a href="javascript:change(${i},${pageInfo.currPage},${pageInfo.pageSize});">${i}</a></li>
		        </c:forEach>
	        </ul>
	    </div>
    </body>
...
<script src="${contextPath}/static/proscenium/js/jquery.min.js"></script>
<script src="${contextPath}/static/proscenium/js/jquery.z-pager.js"></script>
...
<script>
    ...
    function change(currPage,totalPage,pageSize){
    	var start = (currPage-1) * pageSize;
    	$("#" + currPage).addClass("current");
    	$.post('sqr_to_slz_ajax.html?page='+start, function(data) {
			$('#slzContent').html(data);
		});
    	
    	for(var otherPage=0;otherPage<totalPage;otherPage++){
    		if(currPage !=otherPage){
    			$("#"+otherPage).removeClass("current");
    		}
    	}
    }
</script>
