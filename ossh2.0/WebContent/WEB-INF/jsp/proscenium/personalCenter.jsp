...
.cnxh ul li:hover {
	...
	<body   style="">
        ...
        <div  class="main"  id="fixHead">
           <div  class="article">
	           	<div  class="top">
	           		<!-- 
	           		<img   src="${contextPath}/static/proscenium/images/person.jpg "   width="90" height="120">
	           		 -->
	           		<h3 align="center">个人中心</h3> 
	           		<!-- <span  class="top-caption mr-16"  style="margin-left:20px;">实验师</span>
	           		<span  class="top-caption mr-16">网络信息中心</span> -->
	           		
	           		<div style="position:absolute;top:50px;left:300px;">
	           		    <ul  class="topAnnounce" >
	           		     <!-- 
	           		      <li >
	           		         <div style="position:relative;">
	           		           <div  class="todo message"  ></div>
	           		           <div  class="text">消息提醒</div>
	           		           <span  class="tipNumb  messageTip" id="myTrigger2">
	           		           		123
	           		           		
	           		           
	           		           </span>
	           		            <div id="myTip2"  class="tip jq_tips_box2  jq_tips_box_xs2"  directive="right"  style="top:-30px;left:70px; display: none;">
		           		         	  		<i class="jq_tips_arrow2 jq_tips_right2" style="border-right: 10px solid grey;"></i>
			           		         		<div class="jq_tips_info2" style="color: rgb(255, 255, 255);background-color: grey;">星期一开会通知<br/>张大短信<br/>...<br/></div>
		           		        </div>
	           		         </div>
	           		      </li>
	           		      -->
        ...
        <!-- 头部 -->
        <div  class="main2"  id="fixHead2"  style="position:fixed;display:none;right:0px;padding:10px;z-index:10000" >
           <div  class="article">
	           	<div  class="top2">
        ...
        <div  class="dl-main-nav">
        	<ul  class="nav-list ks-clear">
        	   <li  class="nav-item dl-selected  dl-hove">
        ...
        $(function(){
            ...
            $.tan.tab({
           	    hoverClass:"dl-hove",
            	activeClass:"dl-selected",
	           	 title:".dl-main-nav ul  li",
...
$(function(){
	...
	var height=dv.outerHeight(true);
	$(window).scroll(function(){
		 var scrollY = $(document).scrollTop();// 
		 if(scrollY>=(originTop+height)){			
			 //$('#fixHead2').show();			 
		 }else{
			// $('#fixHead2').hide();
		 }
