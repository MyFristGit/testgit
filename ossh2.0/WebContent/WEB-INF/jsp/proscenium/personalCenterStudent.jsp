...
.gridly {
 ...
 .top2 {
  ...
  /*share_start*/
   ...
   .jq_tips_box2{
  	 padding:10px;position:absolute;overflow-x:hidden;display:inline;z-index:10176523;
   }
   .jq_tips_arrow2{
		        ...
		        <div class="dl-tab-conten">
		        	<ul  >
		        	  ...
		        	  <li  class="dl-tab-item" >
		        	  		 <div  style="">
			       			  	<%@ include file="taskCenter_personalCenter_student.jsp"%> 
			       			  </div> 
		        	  </li>
		        	  ...
		        	  <!--学业 -->	
		        	  <li  class="dl-tab-item" style="display:none;"   ajaxUrl="studentAcademic.html"  delayLoad="true">
		        	  		<i class="fa fa-spinner fa-spin"   style="font-size:50px;color:blue;margin:20px;"></i>         	 
		        	  </li>
		        
		        	  
		        	  <!-- 财务 -->		        	 
		        	  <li  class="dl-tab-item" style="display:none;"    ajaxUrl="studentFinance.html"  delayLoad="true">	
			       			<i class="fa fa-spinner fa-spin"   style="font-size:50px;color:blue;margin:20px;"></i> 
		        	  </li>
		        	  ...
		        	  <!-- 科研 -->
		        	  <li  class="dl-tab-item" style="display:none;"    ajaxUrl="studentResearch.html"  delayLoad="true">		        	 
		        	  		<i class="fa fa-spinner fa-spin"   style="font-size:50px;color:blue;margin:20px;"></i> 
		        	  </li>
